...
class Student {
  ...
  Student(String name, String usn, int age, String address, double sgpa1,
          double sgpa2, double sgpa3, double sgpa4, String category) {
    this.name = name;
    this.usn = usn;
    this.age = age;
  ...
  public String toString() {
    return ("Name: " + name + ", USN: " + usn + ", Age: " + age +
...
public class SimpleStudentInfoApp extends JFrame implements ActionListener {
  ...
  private JTextField nameField, usnField, ageField, addressField, sgpa1Field,
      sgpa2Field, sgpa3Field, sgpa4Field, categoryField;
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (command.equals("Compute")) {
      ...
      if (validateFields()) {
        ...
        Student student = new Student(name, usn, age, address, sgpa1, sgpa2,
                                      sgpa3, sgpa4, category);
  ...
  private boolean validateFields() {
    if (nameField.getText().isEmpty() || usnField.getText().isEmpty() ||
        ageField.getText().isEmpty() || addressField.getText().isEmpty() ||
        sgpa1Field.getText().isEmpty() || sgpa2Field.getText().isEmpty() ||
        sgpa3Field.getText().isEmpty() || sgpa4Field.getText().isEmpty() ||
    ...
    try {
      ...
      if (sgpa1 < 0 || sgpa1 > 10 || sgpa2 < 0 || sgpa2 > 10 || sgpa3 < 0 ||
          sgpa3 > 10 || sgpa4 < 0 || sgpa4 > 10) {
        JOptionPane.showMessageDialog(this, "SGPA must be between 0 and 10",
                                      "Validation Error",
                                      JOptionPane.ERROR_MESSAGE);
        return false;
      }
    } catch (NumberFormatException e) {
      JOptionPane.showMessageDialog(this, "SGPA must be a number",
                                    "Validation Error",
                                    JOptionPane.ERROR_MESSAGE);
      return false;
    }
